<div class="left-sidebar bg-black-300 box-shadow ">
  ...
  <!-- <li class="has-children">
   ...
   <li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>List Of Numbers</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="callbacks.php"><i class="fa fa-bars"></i> <span>Callback Requests</span></a></li>
                                            <li><a href="Contacts.php"><i class="fa fa fa-server"></i> <span>Contact us Requests</span></a></li>
                                            <li><a href="Quotes.php"><i class="fa fa fa-server"></i> <span>Request Quotes</span></a></li>
